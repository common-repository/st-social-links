...
global $sociallink_suffix;

$st_social_link_db_ver = "0.0.5";
$sociallink_suffix = "sociallink";
...
function st_social_install(){
	...
	$sociallink_table_name = $wpdb->prefix . $sociallink_suffix;
	
	$sql = "CREATE TABLE " . $sociallink_table_name . " (id mediumint(9) NOT NULL AUTO_INCREMENT, social_network	varchar(50) NOT NULL, social_link_url varchar(255) NOT NULL, img_link		varchar(255) NOT NULL,PRIMARY KEY id (id));";
	...
	update_option("st_social_link_db_ver", $st_social_link_db_ver);
}
...
class st_social_Widget extends WP_Widget {
	...
	function st_social_Widget() {
		...
		/* Create the widget. */
		parent::__construct('st-social-widget', __('Social Links', 'social_link'), $widget_ops, $control_ops );
	}
